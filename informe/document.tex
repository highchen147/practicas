...
\lstset{style=myStyle}
	...
	\begin{definition}
		$u(x,t)$ es una solución débil de la ecuación diferencial $\pdv{u}{t} + \pdv{f(u)}{x}=0$ si para cualquier función suave $\phi(x,t)$ con soporte compacto satisface lo siguiente:
		\begin{equation}
			\int_{0}^{\infty}
		\end{equation}
	\end{definition}	
