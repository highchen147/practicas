...
\lstset{style=myStyle}
	...
	Ahora se demostrará que $u(x,t)$ es la única solución débil de la ecuación \ref{eq:conservative_general}. Suponiendo que el soporte $U$ de $\phi$ está dividido por la recta $x=st$, de tal forma que el conjunto a la izquierda de la recta es $U_L$ y a la derecha es $U_R$. Integrando, se tiene 
	\begin{equation}
