...
%	El objetivo de estas prácticas es describir y evaluar el desempeño de algunos métodos numéricos al utilizarlos en la resolución de la ecuación de Burgers.
	\newpage
	\section{Objetivos}
	\begin{itemize}
	...
	\begin{figure}[ht]
		...
		\caption{Discretización del dominio espacial. \textit{Fuente: elaboración propia a través de Geogebra.}}
	...
	\begin{figure}[ht]
		...
		\begin{subfigure}{0.4\textwidth}
			...
			\label{fig:b1ddf6}
		\end{subfigure}
		\caption{Seis instantes de tiempo de la evolución temporal de la ecuación de Burgers no viscosa con diferencias finitas. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[ht]
		...
		\begin{subfigure}[b]{0.4\textwidth}
			...
			\label{fig:image4}
		\end{subfigure}
		\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers en su versión conservativa, con diferencias finitas.  \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[ht]
		...
		\begin{subfigure}{0.4\textwidth}
			...
			\label{fig:vis1ddf6}
		\end{subfigure}
		\caption{Seis instantes de tiempo de la evolución temporal de tres versiones de la ecuación de Burgers viscosa para diferentes coeficientes de viscosidad, con diferencias finitas. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[ht]
		...
		\begin{subfigure}[b]{0.4\textwidth}
			...
			\label{fig:vis0.3-4}
		\end{subfigure}
		\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers con viscosidad igual a $0.3$, resuelta con diferencias finitas. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[h]
		...
		\end{tikzpicture}
		\caption{Gráfica de condición inicial del caso $u_L > u_R$. \textit{Fuente: elaboración propia}}
	...
	\begin{itemize}
		...
		\begin{figure}[ht]
			...
			\caption*{Gráfica de \texttt{gauss}. \textit{Fuente: elaboración propia}}
		\end{figure}
		...
		\begin{figure}[ht]
			...
			\caption*{Gráfica de \texttt{step\_neg}. \textit{Fuente: elaboración propia}}
		\end{figure}
		...
		\begin{figure}[ht]
			...
			\caption*{Gráfica de \texttt{step\_pos}. \textit{Fuente: elaboración propia}}
		\end{figure}
		...
		\begin{figure}[ht]
			...
			\caption*{Gráfica de \texttt{gauss\_impar}. \textit{Fuente: elaboración propia}}
		\end{figure}
	\end{itemize}
...
% 		
 		...
 		\end{subfigure}
 		\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones de frontera fijas y condición inicial dada por la ecuación \ref{eq:gauss-fija}. \textit{Fuente: elaboración propia}}
 ...
 \begin{figure}[h]
 	...
 	\end{subfigure}
 	\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones de frontera fijas y condición inicial dada por la ecuación \ref{eq:step_neg}. \textit{Fuente: elaboración propia}}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones de frontera fijas y condición inicial dada por la ecuación \ref{eq:step_pos}. \textit{Fuente: elaboración propia}}
...
\end{figure}
	...
	\begin{figure}[h]
		...
		\end{subfigure}
		\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones de frontera fijas y condición inicial dada por la ecuación \ref{eq:gauss_impar}. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[h!]
		...
		\end{subfigure}
		\caption{Seis instantes de tiempo de la evolución temporal de  la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones periódicas de frontera y condición inicial dada por la ecuación \ref{eq:gauss-fija}. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[h!]
		...
		\end{subfigure}
		\caption{Seis instantes de tiempo de la evolución temporal de  la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones periódicas de frontera y condición inicial dada por la ecuación \ref{eq:step_neg}. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[h!]
		...
		\end{subfigure}
		\caption{Seis instantes de tiempo de la evolución temporal de  la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones periódicas de frontera y condición inicial dada por la ecuación \ref{eq:step_pos}. \textit{Fuente: elaboración propia}}
	...
	\begin{figure}[h!]
		...
		\end{subfigure}
		\caption{Seis instantes de tiempo de la evolución temporal de  la ecuación de Burgers resuelta con tres diferentes esquemas del método de volúmenes finitos, con condiciones periódicas de frontera y condición inicial dada por la ecuación \ref{eq:gauss_impar}. \textit{Fuente: elaboración propia}}
	...
	Se programó la versión corregida del esquema de Roe. 
 	\lstinputlisting[title = Esquema de Roe corregido,
	language=C++,
	firstline=81,
	lastline=92,
	keywordstyle=\color{blue}]{../burgers1DVF/code_informe/funciones.cpp}
...
%				\label{fig:step_pos-fija4}
		\end{subfigure}
		\caption{Cuatro instantes de tiempo de la evolución temporal de la ecuación de Burgers resuelta con el esquema de Roe corregido, el esquema de Godunov y la solución exacta dada por la ecuación \ref{eq:sol-riemann-weak-rarefraction}, con condiciones de frontera fijas y condición inicial dada por la ecuación \ref{eq:step_pos}. \textit{Fuente: elaboración propia}}
