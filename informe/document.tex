...
\lstset{style=myStyle}
	...
	\textit{Prueba:} Sea $\phi$ una función de prueba con soporte compacto $U$ y que este último yace completamente en alguno de los dos conjuntos siguientes: $\{x<st\}$ o $\{x>st\}$. Dado que $u(x,t)$ es constante en ambos conjuntos mencionados, esta satisface la ecuación conservativa (\ref{eq:conservative_general}) y consecuentemente se satisface la condición \ref{eq:weak_sol_cond} que garantiza que la solución es una solución débil.
	\begin{figure}[h]
		\centering
